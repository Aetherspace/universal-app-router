...
The [`Button`](/@app-core/components/Button) component is documented from `features/@app-core/components/Button.tsx`:

```tsx filename="features/@app-core/components/Button.tsx"
...
```mdx filename="features/@app-core/components/Button.docs.mdx"
