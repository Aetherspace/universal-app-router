...
<Hidden>- `npx turbo gen model` - Add a new DB model to the project based on a Zod schema</Hidden>
...
<Hidden>- `npx turbo gen domain` - Like `gen workspace` on steroids, full domain with all the above</Hidden>
