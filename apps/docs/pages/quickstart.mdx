...
- [Zod for Single sources of truth](#zod-for-single-sources-of-truth)
- [Universal Data Fetching](#universal-data-fetching)
- [Picking your own Auth / DB / Mail / Storage / ... ](#next-steps-and-plugins)

## Kickstart for Web and Mobile with [FullProduct.dev](https://fullproduct.dev) ⚡️
...
- ✅ **Next.js** for optimized web-vitals, API, SEO and SSR
...
```shell
@app/core
 └── /schemas/... # 👈 Zod based single source of truth
```
...
// ...or on its idividual properties by using '.shape' 👇
...
- ✅ Automatically create the query string, no more manual typing, just pass the bridge
- ✅ Override the default query by passing a custom `graphqlQuery`
- ✅ Automatically infer the input and output types from the bridge or query
- ✅ Can be used on server, browser and mobile with `react-query`

Again, you've skipped some of the complexity of working with GraphQL 🙌
...
Also in `/routes/index.tsx` 👉 Add the Next.js routing config
...
- ✅ Database: [Supabase](TODO) / [Prisma](TODO) / [Drizzle](TODO) / [Mongoose](TODO) / ...?
- ✅ Authentication: [Clerk](TODO) / [Kinde](TODO) / [Supabase](TODO) / custom?
- ✅ Payments: [Stripe](TODO) / [Lemonsqueezy](TODO) / other?
- ✅ Email: `react-email` + [Resend](TODO) / [Mailgun](TODO) / ...?
- ✅ Storage: [UploadThing](TODO) / [Supabase](TODO) / ...?
- ✅ UI kit: [Tamagui](TODO) / [Gluestack](TODO) / ...?
