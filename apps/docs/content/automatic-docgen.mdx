...
The [`healthCheck`](/@app-demo/resolvers/healthCheck) resolver is documented from `features/@app-demo/resolvers/healthCheck.bridge.ts`:

```ts filename="features/@app-demo/resolvers/healthCheck.bridge.ts"
