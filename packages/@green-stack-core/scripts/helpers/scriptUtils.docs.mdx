...
```typescript
globRel('packages/**/*.ts')
// => ['packages/@green-stack-core/utils.ts', 'packages/@app-ui/components.ts']

globRel('features/**/components/*.tsx')
// => ['packages/@app-ui/components/Button.tsx', 'packages/@app-ui/components/Input.tsx']
```
...
//       '@app/core/components/styled': '@app/ui',
