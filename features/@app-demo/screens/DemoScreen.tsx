                ...
                >
                    ...
                    >
                        <View className="w-[57px] h-[98px] lg:w-[114px] lg:h-[197px]">
                            <Image
                                src={require('@app/core/assets/automagic-api-gen-icons.png')}
                        ...
                        <View className="w-[81px] h-[116px] lg:w-[162px] lg:h-[233px]">
                            <Image
                                src={require('@app/core/assets/cross-platform-icons.png')}
                    ...
                    >
                        ...
                        <View className="w-20 h-20 lg:w-24 lg:h-24">
                            <Image
                                src={require('@app/core/assets/green-stack-logo.png')}
        ...
        >
            ...
            >
                <Text className="flex flex-row text-white">
                    ...
                    <Text className="text-white font-bold">@app/demo</Text>
